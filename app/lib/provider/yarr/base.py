...
class nzbBase(rss):
    ...
    nameScores = [
        ...
        'metis:1', 'diamond:1', 'wiki:1', 'cbgb:1', 'crossbow:1', 'sinners:1', 'amiable:1', 'refined:1', 'twizted:1', 'felony:1', 'hubris:1', 'machd:1', 'srt:1', 'bradje:1', 'qoq:1', 'knorloading:1' 
        'nl:1', 'dutch:1', 'german:-10', 'french:-10', 'spanish:-10', 'swesub:-20', 'danish:-10'
    ]
