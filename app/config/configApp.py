...
class configApp():
    ...
    def initConfig(self):
        ...
        self.setDefault('Renamer', 'subDir1', '')
        self.setDefault('Renamer', 'rule1', '')
        self.setDefault('Renamer', 'subDir2', '')
        self.setDefault('Renamer', 'rule2', '')
        self.setDefault('Renamer', 'subDir3', '')
        self.setDefault('Renamer', 'rule3', '')
        self.setDefault('Renamer', 'subDir4', '')
        self.setDefault('Renamer', 'rule4', '')        
